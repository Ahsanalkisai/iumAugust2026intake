      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="glass-strong rounded-t-3xl sm:rounded-3xl w-full max-w-2xl h-[92vh] sm:h-[80vh] flex flex-col relative overflow-hidden"
          >
            {/* Header */}
            <div className="relative px-4 sm:px-5 py-3 sm:py-4 border-b border-white/10 flex items-center justify-between">
            ...
            >
              <div className="flex-1 flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-2xl bg-white/5 border border-white/10 focus-within:border-cyan-glow/50 transition-colors">
                <input
                  value={input}
